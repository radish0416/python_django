"""
Django settings for test_allauth project.
...
SECRET_KEY = '3!0pu778gf@86s8j7_7941s59d2(2ark!f@%bl2#_xf*(=&7@x'
...
ROOT_URLCONF = 'test_allauth.urls'
...
WSGI_APPLICATION = 'test_allauth.wsgi.application'
